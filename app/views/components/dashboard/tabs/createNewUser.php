<div class="grid place-items-center">
    <form action="" enctype="multipart/form-data" method="POST" class="grid place-items-center py-4 w-fit">
        ...
        <div class="flex justify-around items-center gap-4 w-full">
            <div class="relative w-fit mb-4">
                <div class="w-32 h-32 rounded-full overflow-hidden border border-blue-500 shadow-xl">
                    <img src="<?= BASE_URL ?>images/profile.png" alt="upload image" class="w-full h-full object-cover"
            ...
            <div>
                <div class="flex gap-4 mb-4">
                    <div>
                        <label class="block text-gray-700 font-medium mb-2" for="user-type">
                            Select user type:
                        </label>
                        <select
                                class="rounded-full border-blue-500 border w-fit py-3 px-5 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                name="userType"
                                id="user-type">
        ...
        <div class="mb-4">
            <p class="text-gray mb-4">Create password</p>
            <div class="flex gap-4 mb-4">
                <div>
        ...
        <div class="flex items-center justify-end w-full mb-8">
            <div class="flex gap-2">
                <button type="reset" onclick="clearProfileImage()"
