        ...
        <?php if ($isStarted && !$isExpired) : ?>
            <form action="" method="POST" class="grid grid-flow-row gap-4">
                <div class="flex gap-4">
                    ...
                    <button type="submit"
                            class=" w-full grid items-center justify-center py-4 bg-blue text-white rounded-lg hover:shadow-lg hover:-translate-y-0.5 active:shadow-md active:translate-y-0 transition-all duration-300 font-medium">
                        Place Bid
                    </button>
                <p class="text-red">
                    <?= $error ?? ''?>
