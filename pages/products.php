...
<?php require "../components/navbar.php"; ?>
    <div class="w-full bg-blue flex flex-col items-center justify-center gap-8 text-center pt-16 pb-4 shadow-blue-500 shadow-lg">
        <div class="text">
    ...
    <div class="products-wrapper py-12 max-w-screen-xl m-auto">
        ...
        <div class="grid grid-cols-4 gap-8 pt-8">
            <?php for ($i = 0; $i < 16; $i++) : ?>
                <?php require "../components/productCard.php"; ?>
            <?php endfor; ?>
        </div>
